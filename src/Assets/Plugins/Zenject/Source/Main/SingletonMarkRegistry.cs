...
namespace Zenject.Internal
{
    public class SingletonMarkRegistry
    {
        ...
        public void MarkSingleton(Type type)
        {
            ...
            Assert.That(added, "Attempted to use AsSingle multiple times for type '{0}'.  As of Zenject 6+, AsSingle as can no longer be used for the same type across different bindings.  See the upgrade guide for details.", type.PrettyName());
